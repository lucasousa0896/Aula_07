...
public class PaisDAO {
	...
	public ArrayList<Pais> listarPaises(){
		...
		String sqlListar = "select id, nome, populacao, area from pais";
		try(Connection conn = ConnectionFactory.obtemConexao(); PreparedStatement stm = conn.prepareStatement(sqlListar) ){
			try(ResultSet rs = stm.executeQuery()){
				while(rs.next()) {
					pais = new Pais();
	...
	public ArrayList<Pais> listarPaises(String chave){
		...
		String sqlListar = "select id, nome, populacao, area from pais where upper(nome) like ?";
		try(Connection conn = ConnectionFactory.obtemConexao(); PreparedStatement stm = conn.prepareStatement(sqlListar) ){
